 ...
 * and inherits `currentColor` for stroke/fill so Tailwind
 * text-color utilities control the icon color.
 */

export function FacebookIcon({ className, size = 17 }) {
  return (
    <svg
...
export function InstagramIcon({ className, size = 17 }) {
  return (
    <svg
...
export function TiktokIcon({ className, size = 17 }) {
  return (
    <svg
...
export function YoutubeIcon({ className, size = 17 }) {
  return (
    <svg
      viewBox="0 0 256 180"
      width={size}
